"""
Django settings for ProgressBarApp project.
...
SECRET_KEY = 'django-insecure-_hfrb&p6j=(j@k*sq#@x)jx@b6$kl#gezsig465olbmeb7h0yp'
...
ROOT_URLCONF = 'ProgressBarApp.urls'
...
WSGI_APPLICATION = 'ProgressBarApp.wsgi.application'
